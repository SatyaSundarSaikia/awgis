...
//     window.print(); // This function triggers the browser's print dialog
// });
...
//       var value_type = $(this).val();
//       // alert(value_type);
//       var value_attribute = $('#selectAttributes option:selected').text();
//       operator.options[0] = new Option('Select operator', "");
...
//     if (typeof arrributePanel !== 'undefined'){
//         if (arrributePanel.parentElement !== null) {
